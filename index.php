...
<div class="container" style="margin-top:30px;">
	<div class="row">
		...
		<div class="twelvecol last">
			...
			<span style="font-size:62px;font-weight:bold;letter-spacing:0.09em;color:#ff0099;text-shadow:0 0 30px white;letter-spacing:0.03em;text-shadow: 0px 2px 3px #fff;">alias</span>
	...
	<div class="row">
		...
		<div class="twelvecol last">
			<div class="tagline-startpage">
		 	...
		 	Internet product direction, user experience and user interface design
